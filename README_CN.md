<p align="right"><a href="https://github.com/ldkong1205/RoboDepth">English</a> | 简体中文</p>
...
## 安装
Kindly refer to [安装.md](docs/INSTALL_CN.md) for the installation details.
...
### RoboDepth Benchmark
Kindly refer to [数据准备.md](docs/DATA_PREPARE_CN.md) for the details to prepare the <sup>1</sup>[KITTI](http://www.cvlibs.net/datasets/kitti/raw_data.php), <sup>2</sup>[KITTI-C](), <sup>3</sup>[Cityscapes](), <sup>4</sup>[NYUDepth2](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html), and <sup>5</sup>[NYUDepth2-C]() datasets.
...
## 开始实验
Kindly refer to [开始实验.md](docs/GET_STARTED_CN.md) to learn more usage about this codebase.


## 模型库

### :oncoming_automobile: - 室外深度估计

<details open>
<summary>&nbsp<b>自监督深度估计</b></summary>
...
<details open>
<summary>&nbsp<b>全监督深度估计</b></summary>
...
<details open>
<summary>&nbsp<b>半监督深度估计</b></summary>
...
**:bar_chart: 指标:** The following metrics are consistently used in our benchmark:
...
**:gear: 注释:** Symbol <sup>:star:</sup> denotes the baseline model adopted in *mCE* calculation.
...
| [MonoViT<sub>MPViT+HR</sub>]() | M+S | 74.95 | 89.72 | 0.094 | 0.102 | 0.238 | 0.114 | 0.225 | 0.269 | 0.117 | 0.145 | 0.171 | 0.145 | 0.184 | 0.108 | 0.145 | 0.302 | 0.277 | 0.259 | 0.285 | 0.135 | 0.148 |
...
For more detailed benchmarking results and to access the pretrained weights used in robustness evaluation, kindly refer to [实验结果.md](docs/RESULT_CN.md).


## 生成"损坏"数据
You can manage to create your own "RoboDepth" corrpution sets! Follow the instructions listed in [数据生成.md](docs/CREATE_CN.md).
