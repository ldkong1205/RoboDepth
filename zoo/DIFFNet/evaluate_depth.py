...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        depth_decoder.load_state_dict(dec_model_dict)
...
if __name__ == "__main__":
    ...
    opt.load_weights_folder = 'models/DIFFNet/diffnet_640x192'
    opt.eval_mono, opt.eval_stereo = False, True
    opt.num_workers = 0
    opt.batch_size = 1
