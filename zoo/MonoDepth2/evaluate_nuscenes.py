...
def infer(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        dataloader = DataLoader(dataset, opt.batch_size, shuffle=False, collate_fn=my_collate, num_workers=opt.num_workers, pin_memory=True, drop_last=False)
        ...
        # TODO: add dist evaluation
        local_rank = 0
        with open(os.path.join('./log', 'eval', '{}.pkl'.format(local_rank)), 'wb') as f:
