# Adapted from https://github.com/nianticlabs/manydepth
# 
...
class ManyDepthMonoDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        super(ManyDepthMonoDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        city, frame_index = self.index_to_folder_and_frame_idx(index)

        poses = {}
        if type(self).__name__ in ["CityscapesPreprocessedDataset", "CityscapesEvalDataset", "CityscapesFoggyEvalDataset"]:
            inputs.update(self.get_colors(frame_index, do_flip))
        else:
        ...
        for scale in range(self.num_scales):
            K = self.load_intrinsics(city, frame_index)
