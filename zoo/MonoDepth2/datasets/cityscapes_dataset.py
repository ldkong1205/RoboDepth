...
from .manydepth_mono_dataset import ManyDepthMonoDataset


class CityscapesEvalDataset(ManyDepthMonoDataset):
    ...
    def index_to_folder_and_frame_idx(self, index):
        ...
        city = os.path.basename(frame_name).split('_')[0]
    ...
    def load_intrinsics(self, city, frame_name):
        ...
        # hard code here
        # TODO: improve this
        frame_name = frame_name[:-len('_leftImg8bit.png')]
    ...
    def get_color(self, frame_name, do_flip):

        color = self.loader(frame_name)
    ...
    def get_colors(self, frame_name, do_flip):

        color = self.get_color(frame_name, do_flip)

        ## Do not need multiple frame for MonoDepthV2 eval
