...
def evaluate(opt, corruption, severity, logger, info):
    ...
    # for debugging
    # opt.data_path = '/nvme/konglingdong/models/RoboDepth/kitti_data'
    # opt.eval_corr_type = 'all'
    # opt.model = 'lite-mono'
    # opt.load_weights_folder = '/nvme/konglingdong/models/RoboDepth/models/Lite-Mono/lite-mono_640x192'
